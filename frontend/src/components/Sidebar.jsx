...
const SiteSettingsIcon = () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-2.11.845a2 2 0 01-2.288 0l-2.11-.845a6 6 0 00-3.86-.517l-2.387.477a2 2 0 00-1.022.547m3.234 2.346a2 2 0 012.288 0l2.11.845a6 6 0 003.86.517l2.387-.477a2 2 0 011.022.547m-15.576 0l2.387.477a6 6 0 013.86.517l2.11.845a2 2 0 002.288 0l2.11-.845a6 6 0 013.86.517l2.387-.477m-15.576 0a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-2.11.845a2 2 0 01-2.288 0l-2.11-.845a6 6 0 00-3.86-.517l-2.387.477a2 2 0 00-1.022.547M12 6a3 3 0 110-6 3 3 0 010 6z" /></svg>;
      ...
      case 'super_admin':
        return [
          ...
          },
          {
            section: 'Settings',
            items: [
              { label: 'Account Settings', path: '/settings', icon: <SettingsIcon /> },
              { label: 'Site Settings', path: '/site-settings', icon: <SiteSettingsIcon /> },
              { label: 'Pricing Plans', path: '/pricing-plans', icon: <PricingPlansIcon /> },
              { label: 'Plan Purchases', path: '/plan-purchases', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg> },
              { label: 'Payment Methods', path: '/payment-methods', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg> },
            ]
          },
          {
            section: 'Support',
            items: [
              { label: 'Live Chat', path: '/admin-chat', icon: <ChatIcon />, badge: unreadChatCount },
            ]
          }
        ];
      case 'shop_admin':
